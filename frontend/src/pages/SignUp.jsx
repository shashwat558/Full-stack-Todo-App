            ...
            <div className='flex flex-col md:flex-row md:justify-around h-full items-center'>
                <div className="md:w-1/2 flex justify-center items-center h-full">
                    <div className="max-w-lg relative flex flex-col p-4 rounded-md text-black bg-neutral-300 md:mt-20 mt-20">
                        ...
                        <div className="text-sm font-normal mb-4 text-center text-[#1e0e4b]"> Let's create a new account</div>
                        <form className="flex flex-col gap-3">
                            ...
                            <button 
                                ...
                                type="submit" className="bg-[#7747ff] w-max m-auto px-6 py-2 rounded text-white text-sm font-normal">Sign up</button>
                        </form>
                        <div className="text-sm text-center mt-[1.6rem]">
                            Already have an account yet? <span className="text-sm text-[#7747ff]"><Link to={'/Login'}>Sign In now</Link></span>
                        </div>
                    </div>
                </div>
                <div className='flex justify-center md:pl-10 items-center md:w-1/2 h-full w-full mt-20'>
